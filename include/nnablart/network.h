...
#define NN_BINARY_FORMAT_REVISION 7a321eed7fb29e6924b797d0dee0538e
...
typedef enum {
  ...
  NN_FUNCTION_LEAKY_RELU = 15,                  ///< LeakyReLU
  ...
  NN_FUNCTION_CLIP_GRAD_BY_VALUE = 24,          ///< ClipGradByValue
  NN_FUNCTION_CLIP_GRAD_BY_NORM = 25,           ///< ClipGradByNorm
  NN_FUNCTION_SUM = 26,                         ///< Sum
  NN_FUNCTION_MEAN = 27,                        ///< Mean
  NN_FUNCTION_MAX = 28,                         ///< Max
  NN_FUNCTION_MIN = 29,                         ///< Min
  NN_FUNCTION_PROD = 30,                        ///< Prod
  NN_FUNCTION_REDUCE_SUM = 31,                  ///< ReduceSum
  NN_FUNCTION_REDUCE_MEAN = 32,                 ///< ReduceMean
  NN_FUNCTION_ADD2 = 33,                        ///< Add2
  NN_FUNCTION_BC_ADD2 = 34,                     ///< BcAdd2
  NN_FUNCTION_SUB2 = 35,                        ///< Sub2
  NN_FUNCTION_MUL2 = 36,                        ///< Mul2
  NN_FUNCTION_DIV2 = 37,                        ///< Div2
  NN_FUNCTION_POW2 = 38,                        ///< Pow2
  NN_FUNCTION_ADD_SCALAR = 39,                  ///< AddScalar
  NN_FUNCTION_MUL_SCALAR = 40,                  ///< MulScalar
  NN_FUNCTION_POW_SCALAR = 41,                  ///< PowScalar
  NN_FUNCTION_R_SUB_SCALAR = 42,                ///< RSubScalar
  NN_FUNCTION_R_DIV_SCALAR = 43,                ///< RDivScalar
  NN_FUNCTION_R_POW_SCALAR = 44,                ///< RPowScalar
  NN_FUNCTION_SIGN = 45,                        ///< Sign
  NN_FUNCTION_MINIMUM2 = 46,                    ///< Minimum2
  NN_FUNCTION_MAXIMUM2 = 47,                    ///< Maximum2
  NN_FUNCTION_MINIMUM_SCALAR = 48,              ///< MinimumScalar
  NN_FUNCTION_MAXIMUM_SCALAR = 49,              ///< MaximumScalar
  NN_FUNCTION_LOGICAL_AND = 50,                 ///< LogicalAnd
  NN_FUNCTION_LOGICAL_OR = 51,                  ///< LogicalOr
  NN_FUNCTION_LOGICAL_XOR = 52,                 ///< LogicalXor
  NN_FUNCTION_EQUAL = 53,                       ///< Equal
  NN_FUNCTION_NOT_EQUAL = 54,                   ///< NotEqual
  NN_FUNCTION_GREATER_EQUAL = 55,               ///< GreaterEqual
  NN_FUNCTION_GREATER = 56,                     ///< Greater
  NN_FUNCTION_LESS_EQUAL = 57,                  ///< LessEqual
  NN_FUNCTION_LESS = 58,                        ///< Less
  NN_FUNCTION_LOGICAL_AND_SCALAR = 59,          ///< LogicalAndScalar
  NN_FUNCTION_LOGICAL_OR_SCALAR = 60,           ///< LogicalOrScalar
  NN_FUNCTION_LOGICAL_XOR_SCALAR = 61,          ///< LogicalXorScalar
  NN_FUNCTION_EQUAL_SCALAR = 62,                ///< EqualScalar
  NN_FUNCTION_NOT_EQUAL_SCALAR = 63,            ///< NotEqualScalar
  NN_FUNCTION_GREATER_EQUAL_SCALAR = 64,        ///< GreaterEqualScalar
  NN_FUNCTION_GREATER_SCALAR = 65,              ///< GreaterScalar
  NN_FUNCTION_LESS_EQUAL_SCALAR = 66,           ///< LessEqualScalar
  NN_FUNCTION_LESS_SCALAR = 67,                 ///< LessScalar
  NN_FUNCTION_LOGICAL_NOT = 68,                 ///< LogicalNot
  NN_FUNCTION_CONSTANT = 69,                    ///< Constant
  NN_FUNCTION_ABS = 70,                         ///< Abs
  NN_FUNCTION_EXP = 71,                         ///< Exp
  NN_FUNCTION_LOG = 72,                         ///< Log
  NN_FUNCTION_IDENTITY = 73,                    ///< Identity
  NN_FUNCTION_BATCH_MATMUL = 74,                ///< BatchMatmul
  NN_FUNCTION_ROUND = 75,                       ///< Round
  NN_FUNCTION_CEIL = 76,                        ///< Ceil
  NN_FUNCTION_FLOOR = 77,                       ///< Floor
  NN_FUNCTION_SIN = 78,                         ///< Sin
  NN_FUNCTION_COS = 79,                         ///< Cos
  NN_FUNCTION_TAN = 80,                         ///< Tan
  NN_FUNCTION_SINH = 81,                        ///< Sinh
  NN_FUNCTION_COSH = 82,                        ///< Cosh
  NN_FUNCTION_ASIN = 83,                        ///< ASin
  NN_FUNCTION_ACOS = 84,                        ///< ACos
  NN_FUNCTION_ATAN = 85,                        ///< ATan
  NN_FUNCTION_ASINH = 86,                       ///< ASinh
  NN_FUNCTION_ACOSH = 87,                       ///< ACosh
  NN_FUNCTION_ATANH = 88,                       ///< ATanh
  NN_FUNCTION_CONCATENATE = 89,                 ///< Concatenate
  NN_FUNCTION_SPLIT = 90,                       ///< Split
  NN_FUNCTION_STACK = 91,                       ///< Stack
  NN_FUNCTION_SLICE = 92,                       ///< Slice
  NN_FUNCTION_PAD = 93,                         ///< Pad
  NN_FUNCTION_TRANSPOSE = 94,                   ///< Transpose
  NN_FUNCTION_BROADCAST = 95,                   ///< Broadcast
  NN_FUNCTION_BROADCAST_TO = 96,                ///< BroadcastTo
  NN_FUNCTION_ONE_HOT = 97,                     ///< OneHot
  NN_FUNCTION_FLIP = 98,                        ///< Flip
  NN_FUNCTION_SHIFT = 99,                       ///< Shift
  NN_FUNCTION_RESHAPE = 100,                    ///< Reshape
  NN_FUNCTION_MATRIX_DIAG = 101,                ///< MatrixDiag
  NN_FUNCTION_MATRIX_DIAG_PART = 102,           ///< MatrixDiagPart
  NN_FUNCTION_INTERPOLATE = 103,                ///< Interpolate
  NN_FUNCTION_FFT = 104,                        ///< FFT
  NN_FUNCTION_IFFT = 105,                       ///< IFFT
  NN_FUNCTION_DROPOUT = 106,                    ///< Dropout
  NN_FUNCTION_TOP_K_DATA = 107,                 ///< TopKData
  NN_FUNCTION_TOP_K_GRAD = 108,                 ///< TopKGrad
  NN_FUNCTION_RAND = 109,                       ///< Rand
  NN_FUNCTION_RANDINT = 110,                    ///< Randint
  NN_FUNCTION_RANDN = 111,                      ///< Randn
  NN_FUNCTION_RANDOM_CROP = 112,                ///< RandomCrop
  NN_FUNCTION_RANDOM_FLIP = 113,                ///< RandomFlip
  NN_FUNCTION_RANDOM_SHIFT = 114,               ///< RandomShift
  NN_FUNCTION_IMAGE_AUGMENTATION = 115,         ///< ImageAugmentation
  NN_FUNCTION_SIGMOID_CROSS_ENTROPY = 116,      ///< SigmoidCrossEntropy
  NN_FUNCTION_BINARY_CROSS_ENTROPY = 117,       ///< BinaryCrossEntropy
  NN_FUNCTION_SOFTMAX_CROSS_ENTROPY = 118,      ///< SoftmaxCrossEntropy
  NN_FUNCTION_CATEGORICAL_CROSS_ENTROPY = 119,  ///< CategoricalCrossEntropy
  NN_FUNCTION_SQUARED_ERROR = 120,              ///< SquaredError
  NN_FUNCTION_ABSOLUTE_ERROR = 121,             ///< AbsoluteError
  NN_FUNCTION_HUBER_LOSS = 122,                 ///< HuberLoss
  NN_FUNCTION_EPSILON_INSENSITIVE_LOSS = 123,   ///< EpsilonInsensitiveLoss
  NN_FUNCTION_KL_MULTINOMIAL = 124,             ///< KLMultinomial
  NN_FUNCTION_BINARY_SIGMOID = 125,             ///< BinarySigmoid
  NN_FUNCTION_BINARY_TANH = 126,                ///< BinaryTanh
  NN_FUNCTION_BINARY_CONNECT_AFFINE = 127,      ///< BinaryConnectAffine
  NN_FUNCTION_BINARY_CONNECT_CONVOLUTION = 128, ///< BinaryConnectConvolution
  NN_FUNCTION_BINARY_WEIGHT_AFFINE = 129,       ///< BinaryWeightAffine
  NN_FUNCTION_BINARY_WEIGHT_CONVOLUTION = 130,  ///< BinaryWeightConvolution
  NN_FUNCTION_INQ_AFFINE = 131,                 ///< INQAffine
  NN_FUNCTION_INQ_CONVOLUTION = 132,            ///< INQConvolution
  NN_FUNCTION_FIXED_POINT_QUANTIZE = 133,       ///< FixedPointQuantize
  NN_FUNCTION_POW2_QUANTIZE = 134,              ///< Pow2Quantize
  NN_FUNCTION_TOP_N_ERROR = 135,                ///< TopNError
  NN_FUNCTION_BINARY_ERROR = 136,               ///< BinaryError
  NN_FUNCTION_CONFUSION_MATRIX = 137,           ///< ConfusionMatrix
  NN_FUNCTION_VAT_NOISE = 138,                  ///< VATNoise
  NN_FUNCTION_UNLINK = 139,                     ///< Unlink
  NN_FUNCTION_SINK = 140,                       ///< Sink
  NN_FUNCTION_NMS_DETECTION2D = 141,            ///< NmsDetection2d
