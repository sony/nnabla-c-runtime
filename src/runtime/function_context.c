...
rt_function_context_t allocate_function_context(nn_network_t *n,
  ...
  case NN_FUNCTION_AFFINE: { // Affine
    ...
    func.free_local_context_func = free_affine_local_context;
  ...
  case NN_FUNCTION_CONVOLUTION: { // Convolution
    ...
    func.free_local_context_func = free_convolution_local_context;
  ...
  case NN_FUNCTION_DEPTHWISE_CONVOLUTION: { // DepthwiseConvolution
    ...
    func.free_local_context_func = free_depthwise_convolution_local_context;
  ...
  case NN_FUNCTION_DECONVOLUTION: { // Deconvolution
    ...
    func.free_local_context_func = free_deconvolution_local_context;
  ...
  case NN_FUNCTION_DEPTHWISE_DECONVOLUTION: { // DepthwiseDeconvolution
    ...
    func.free_local_context_func = free_depthwise_deconvolution_local_context;
  ...
  case NN_FUNCTION_MAX_POOLING: { // MaxPooling
    ...
    func.free_local_context_func = free_max_pooling_local_context;
  ...
  case NN_FUNCTION_AVERAGE_POOLING: { // AveragePooling
    ...
    func.free_local_context_func = free_average_pooling_local_context;
  ...
  case NN_FUNCTION_GLOBAL_AVERAGE_POOLING: { // GlobalAveragePooling
    ...
    func.free_local_context_func = free_global_average_pooling_local_context;
  ...
  case NN_FUNCTION_SUM_POOLING: { // SumPooling
    ...
    func.free_local_context_func = free_sum_pooling_local_context;
  ...
  case NN_FUNCTION_UNPOOLING: { // Unpooling
    ...
    func.free_local_context_func = free_unpooling_local_context;
  ...
  case NN_FUNCTION_EMBED: { // Embed
    ...
    func.free_local_context_func = free_embed_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_SIGMOID: { // Sigmoid
    ...
    func.free_local_context_func = free_sigmoid_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_SWISH: { // Swish
    ...
    func.free_local_context_func = free_swish_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_TANH: { // Tanh
    ...
    func.free_local_context_func = free_tanh_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_RELU: { // ReLU
    ...
    func.free_local_context_func = free_relu_local_context;
  ...
  case NN_FUNCTION_LEAKY_RELU: { // LeakyReLU
    ...
    func.free_local_context_func = free_leaky_relu_local_context;
  ...
  case NN_FUNCTION_SOFTMAX: { // Softmax
    ...
    func.free_local_context_func = free_softmax_local_context;
  ...
  case NN_FUNCTION_ELU: { // ELU
    ...
    func.free_local_context_func = free_elu_local_context;
  ...
  case NN_FUNCTION_SELU: { // SELU
    ...
    func.free_local_context_func = free_selu_local_context;
  ...
  case NN_FUNCTION_CRELU: { // CReLU
    ...
    func.free_local_context_func = free_crelu_local_context;
  ...
  case NN_FUNCTION_CELU: { // CELU
    ...
    func.free_local_context_func = free_celu_local_context;
  ...
  case NN_FUNCTION_PRELU: { // PReLU
    ...
    func.free_local_context_func = free_prelu_local_context;
  ...
  case NN_FUNCTION_BATCH_NORMALIZATION: { // BatchNormalization
    ...
    func.free_local_context_func = free_batch_normalization_local_context;
  ...
  case NN_FUNCTION_MEAN_SUBTRACTION: { // MeanSubtraction
    ...
    func.free_local_context_func = free_mean_subtraction_local_context;
  ...
  case NN_FUNCTION_SUM: { // Sum
    ...
    func.free_local_context_func = free_sum_local_context;
  ...
  case NN_FUNCTION_MEAN: { // Mean
    ...
    func.free_local_context_func = free_mean_local_context;
  ...
  case NN_FUNCTION_MAX: { // Max
    ...
    func.free_local_context_func = free_max_local_context;
  ...
  case NN_FUNCTION_MIN: { // Min
    ...
    func.free_local_context_func = free_min_local_context;
  ...
  case NN_FUNCTION_PROD: { // Prod
    ...
    func.free_local_context_func = free_prod_local_context;
  ...
  case NN_FUNCTION_REDUCE_SUM: { // ReduceSum
    ...
    func.free_local_context_func = free_reduce_sum_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_REDUCE_MEAN: { // ReduceMean
    ...
    func.free_local_context_func = free_reduce_mean_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_ADD2: { // Add2
    ...
    func.free_local_context_func = free_add2_local_context;
  ...
  case NN_FUNCTION_BC_ADD2: { // BcAdd2
    ...
    func.free_local_context_func = free_bc_add2_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_SUB2: { // Sub2
    ...
    func.free_local_context_func = free_sub2_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_MUL2: { // Mul2
    ...
    func.free_local_context_func = free_mul2_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_DIV2: { // Div2
    ...
    func.free_local_context_func = free_div2_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_POW2: { // Pow2
    ...
    func.free_local_context_func = free_pow2_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_ADD_SCALAR: { // AddScalar
    ...
    func.free_local_context_func = free_add_scalar_local_context;
  ...
  case NN_FUNCTION_MUL_SCALAR: { // MulScalar
    ...
    func.free_local_context_func = free_mul_scalar_local_context;
  ...
  case NN_FUNCTION_POW_SCALAR: { // PowScalar
    ...
    func.free_local_context_func = free_pow_scalar_local_context;
  ...
  case NN_FUNCTION_R_SUB_SCALAR: { // RSubScalar
    ...
    func.free_local_context_func = free_r_sub_scalar_local_context;
  ...
  case NN_FUNCTION_R_DIV_SCALAR: { // RDivScalar
    ...
    func.free_local_context_func = free_r_div_scalar_local_context;
  ...
  case NN_FUNCTION_R_POW_SCALAR: { // RPowScalar
    ...
    func.free_local_context_func = free_r_pow_scalar_local_context;
  ...
  case NN_FUNCTION_SIGN: { // Sign
    ...
    func.free_local_context_func = free_sign_local_context;
  ...
  case NN_FUNCTION_MINIMUM2: { // Minimum2
    ...
    func.free_local_context_func = free_minimum2_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_MAXIMUM2: { // Maximum2
    ...
    func.free_local_context_func = free_maximum2_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_MINIMUM_SCALAR: { // MinimumScalar
    ...
    func.free_local_context_func = free_minimum_scalar_local_context;
  ...
  case NN_FUNCTION_MAXIMUM_SCALAR: { // MaximumScalar
    ...
    func.free_local_context_func = free_maximum_scalar_local_context;
  ...
  case NN_FUNCTION_LOGICAL_AND: { // LogicalAnd
    ...
    func.free_local_context_func = free_logical_and_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_LOGICAL_OR: { // LogicalOr
    ...
    func.free_local_context_func = free_logical_or_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_LOGICAL_XOR: { // LogicalXor
    ...
    func.free_local_context_func = free_logical_xor_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_EQUAL: { // Equal
    ...
    func.free_local_context_func = free_equal_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_NOT_EQUAL: { // NotEqual
    ...
    func.free_local_context_func = free_not_equal_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_GREATER_EQUAL: { // GreaterEqual
    ...
    func.free_local_context_func = free_greater_equal_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_GREATER: { // Greater
    ...
    func.free_local_context_func = free_greater_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_LESS_EQUAL: { // LessEqual
    ...
    func.free_local_context_func = free_less_equal_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_LESS: { // Less
    ...
    func.free_local_context_func = free_less_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_LOGICAL_AND_SCALAR: { // LogicalAndScalar
    ...
    func.free_local_context_func = free_logical_and_scalar_local_context;
  ...
  case NN_FUNCTION_LOGICAL_OR_SCALAR: { // LogicalOrScalar
    ...
    func.free_local_context_func = free_logical_or_scalar_local_context;
  ...
  case NN_FUNCTION_LOGICAL_XOR_SCALAR: { // LogicalXorScalar
    ...
    func.free_local_context_func = free_logical_xor_scalar_local_context;
  ...
  case NN_FUNCTION_EQUAL_SCALAR: { // EqualScalar
    ...
    func.free_local_context_func = free_equal_scalar_local_context;
  ...
  case NN_FUNCTION_NOT_EQUAL_SCALAR: { // NotEqualScalar
    ...
    func.free_local_context_func = free_not_equal_scalar_local_context;
  ...
  case NN_FUNCTION_GREATER_EQUAL_SCALAR: { // GreaterEqualScalar
    ...
    func.free_local_context_func = free_greater_equal_scalar_local_context;
  ...
  case NN_FUNCTION_GREATER_SCALAR: { // GreaterScalar
    ...
    func.free_local_context_func = free_greater_scalar_local_context;
  ...
  case NN_FUNCTION_LESS_EQUAL_SCALAR: { // LessEqualScalar
    ...
    func.free_local_context_func = free_less_equal_scalar_local_context;
  ...
  case NN_FUNCTION_LESS_SCALAR: { // LessScalar
    ...
    func.free_local_context_func = free_less_scalar_local_context;
  ...
  case NN_FUNCTION_LOGICAL_NOT: { // LogicalNot
    ...
    func.free_local_context_func = free_logical_not_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_CONSTANT: { // Constant
    ...
    func.free_local_context_func = free_constant_local_context;
  ...
  case NN_FUNCTION_ABS: { // Abs
    ...
    func.free_local_context_func = free_abs_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_EXP: { // Exp
    ...
    func.free_local_context_func = free_exp_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_LOG: { // Log
    ...
    func.free_local_context_func = free_log_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_IDENTITY: { // Identity
    ...
    func.free_local_context_func = free_identity_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_BATCH_MATMUL: { // BatchMatmul
    ...
    func.free_local_context_func = free_batch_matmul_local_context;
  ...
  case NN_FUNCTION_ROUND: { // Round
    ...
    func.free_local_context_func = free_round_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_CONCATENATE: { // Concatenate
    ...
    func.free_local_context_func = free_concatenate_local_context;
  ...
  case NN_FUNCTION_SPLIT: { // Split
    ...
    func.free_local_context_func = free_split_local_context;
  ...
  case NN_FUNCTION_STACK: { // Stack
    ...
    func.free_local_context_func = free_stack_local_context;
  ...
  case NN_FUNCTION_SLICE: { // Slice
    ...
    func.free_local_context_func = free_slice_local_context;
  ...
  case NN_FUNCTION_TRANSPOSE: { // Transpose
    ...
    func.free_local_context_func = free_transpose_local_context;
  ...
  case NN_FUNCTION_BROADCAST: { // Broadcast
    ...
    func.free_local_context_func = free_broadcast_local_context;
  ...
  case NN_FUNCTION_ONE_HOT: { // OneHot
    ...
    func.free_local_context_func = free_one_hot_local_context;
  ...
  case NN_FUNCTION_FLIP: { // Flip
    ...
    func.free_local_context_func = free_flip_local_context;
  ...
  case NN_FUNCTION_SHIFT: { // Shift
    ...
    func.free_local_context_func = free_shift_local_context;
  ...
  case NN_FUNCTION_RESHAPE: { // Reshape
    ...
    func.free_local_context_func = free_reshape_local_context;
  ...
  case NN_FUNCTION_MATRIX_DIAG: { // MatrixDiag
    ...
    func.free_local_context_func = free_matrix_diag_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_MATRIX_DIAG_PART: { // MatrixDiagPart
    ...
    func.free_local_context_func = free_matrix_diag_part_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_DROPOUT: { // Dropout
    ...
    func.free_local_context_func = free_dropout_local_context;
  ...
  case NN_FUNCTION_TOP_K_DATA: { // TopKData
    ...
    func.free_local_context_func = free_top_k_data_local_context;
  ...
  case NN_FUNCTION_TOP_K_GRAD: { // TopKGrad
    ...
    func.free_local_context_func = free_top_k_grad_local_context;
  ...
  case NN_FUNCTION_RAND: { // Rand
    ...
    func.free_local_context_func = free_rand_local_context;
  ...
  case NN_FUNCTION_RANDINT: { // Randint
    ...
    func.free_local_context_func = free_randint_local_context;
  ...
  case NN_FUNCTION_RANDN: { // Randn
    ...
    func.free_local_context_func = free_randn_local_context;
  ...
  case NN_FUNCTION_RANDOM_CROP: { // RandomCrop
    ...
    func.free_local_context_func = free_random_crop_local_context;
  ...
  case NN_FUNCTION_RANDOM_FLIP: { // RandomFlip
    ...
    func.free_local_context_func = free_random_flip_local_context;
  ...
  case NN_FUNCTION_RANDOM_SHIFT: { // RandomShift
    ...
    func.free_local_context_func = free_random_shift_local_context;
  ...
  case NN_FUNCTION_IMAGE_AUGMENTATION: { // ImageAugmentation
    ...
    func.free_local_context_func = free_image_augmentation_local_context;
  ...
  case NN_FUNCTION_SIGMOID_CROSS_ENTROPY: { // SigmoidCrossEntropy
    ...
    func.free_local_context_func = free_sigmoid_cross_entropy_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_BINARY_CROSS_ENTROPY: { // BinaryCrossEntropy
    ...
    func.free_local_context_func = free_binary_cross_entropy_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_SOFTMAX_CROSS_ENTROPY: { // SoftmaxCrossEntropy
    ...
    func.free_local_context_func = free_softmax_cross_entropy_local_context;
  ...
  case NN_FUNCTION_CATEGORICAL_CROSS_ENTROPY: { // CategoricalCrossEntropy
    ...
    func.free_local_context_func = free_categorical_cross_entropy_local_context;
  ...
  case NN_FUNCTION_SQUARED_ERROR: { // SquaredError
    ...
    func.free_local_context_func = free_squared_error_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_ABSOLUTE_ERROR: { // AbsoluteError
    ...
    func.free_local_context_func = free_absolute_error_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_HUBER_LOSS: { // HuberLoss
    ...
    func.free_local_context_func = free_huber_loss_local_context;
  ...
  case NN_FUNCTION_EPSILON_INSENSITIVE_LOSS: { // EpsilonInsensitiveLoss
    ...
    func.free_local_context_func = free_epsilon_insensitive_loss_local_context;
  ...
  case NN_FUNCTION_KL_MULTINOMIAL: { // KLMultinomial
    ...
    func.free_local_context_func = free_kl_multinomial_local_context;
  ...
  case NN_FUNCTION_BINARY_SIGMOID: { // BinarySigmoid
    ...
    func.free_local_context_func = free_binary_sigmoid_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_BINARY_TANH: { // BinaryTanh
    ...
    func.free_local_context_func = free_binary_tanh_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_BINARY_CONNECT_AFFINE: { // BinaryConnectAffine
    ...
    func.free_local_context_func = free_binary_connect_affine_local_context;
  ...
  case NN_FUNCTION_BINARY_WEIGHT_AFFINE: { // BinaryWeightAffine
    ...
    func.free_local_context_func = free_binary_weight_affine_local_context;
  ...
  case NN_FUNCTION_BINARY_WEIGHT_CONVOLUTION: { // BinaryWeightConvolution
    ...
    func.free_local_context_func = free_binary_weight_convolution_local_context;
  ...
  case NN_FUNCTION_INQ_AFFINE: { // INQAffine
    ...
    func.free_local_context_func = free_inq_affine_local_context;
  ...
  case NN_FUNCTION_INQ_CONVOLUTION: { // INQConvolution
    ...
    func.free_local_context_func = free_inq_convolution_local_context;
  ...
  case NN_FUNCTION_FIXED_POINT_QUANTIZE: { // FixedPointQuantize
    ...
    func.free_local_context_func = free_fixed_point_quantize_local_context;
  ...
  case NN_FUNCTION_POW2_QUANTIZE: { // Pow2Quantize
    ...
    func.free_local_context_func = free_pow2_quantize_local_context;
  ...
  case NN_FUNCTION_TOP_N_ERROR: { // TopNError
    ...
    func.free_local_context_func = free_top_n_error_local_context;
  ...
  case NN_FUNCTION_BINARY_ERROR: { // BinaryError
    ...
    func.free_local_context_func = free_binary_error_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_CONFUSION_MATRIX: { // ConfusionMatrix
    ...
    func.free_local_context_func = free_confusion_matrix_local_context;
  ...
  case NN_FUNCTION_VAT_NOISE: { // VATNoise
    ...
    func.free_local_context_func = free_vat_noise_local_context;
  ...
  case NN_FUNCTION_UNLINK: { // Unlink
    ...
    func.free_local_context_func = free_unlink_local_context;
    func.func.local_context = 0;
  ...
  case NN_FUNCTION_SINK: { // Sink
    ...
    func.free_local_context_func = free_sink_local_context;
